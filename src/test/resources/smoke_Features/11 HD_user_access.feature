@smoke
Feature: IC Helpdesk user can see and use the User Details Screen
  As an IC Helpdesk role user, I want to view and use the Search Users and User Details Screen

  Background:
    Given TestName "IC HD user can see User Details Screen" the landing page is loaded
