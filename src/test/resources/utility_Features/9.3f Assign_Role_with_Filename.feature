...
#    "UI" - Enter Data in UI but do not click Assign ~ useful when using a mass of unknown Custom Attributes
      ...
      | PCF3    | assignsRoles_MultipleAssignments_PCFSB.xlsx | N                    |
...
#mvn clean install -e -X -Dselenium.box.token=e08502d7-7d10-46 -Denvironment=VALAWS -Dcucumber.filter.tags=@UtilAssignRoleParallel